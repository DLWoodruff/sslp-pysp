...
echo "^^^ sslp fwph ^^^"
cd sslp
mpiexec -np 40 python -u -m mpi4py ../../mpisppy/generic_cylinders.py --module-name sslp --sslp-data-path ./data --instance-name ${INSTANCE_NAME} --solver-name ${SOLVER} --max-iterations 10 --max-solver-threads 4 --default-rho 0.1 --fwph-hub --xhatshuffle --rel-gap 1e-6 --abs-gap 1e-6 --scenarios-per-bundle=${SPB} --iter0-mipgap=0.01 --iterk-mipgap=0.002   --solver-options="timelimit=600" --surrogate-nonant
